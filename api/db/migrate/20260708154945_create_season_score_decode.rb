class CreateSeasonScoreDecode < ActiveRecord::Migration[8.0]
  def change
    reversible do |dir|
      dir.up do
        execute <<~SQL
          CREATE TYPE decode_artifact AS ENUM ('NONE', 'PURPLE', 'GREEN');
          CREATE TYPE decode_teleop_robot_status AS ENUM ('NONE', 'PARTIAL', 'FULL');
        SQL
      end
      dir.down do
        execute <<~SQL
          DROP TYPE decode_artifact;
          DROP TYPE decode_teleop_robot_status;
        SQL
      end
    end
    create_table :decode_scores do |t|
      t.integer :auto_classified_artifacts, default: 0
      t.integer :auto_overflow_artifacts, default: 0
      t.column :auto_classifier_state, :decode_artifact, array: true, default: '{NONE,NONE,NONE,NONE,NONE,NONE,NONE,NONE,NONE}'
      ...
      t.column :teleop_classifier_state, :decode_artifact, array: true, default: '{NONE,NONE,NONE,NONE,NONE,NONE,NONE,NONE,NONE}'
