import ScoreTable, {SeasonScore} from './ScoreTable.js';
// TODO unignore
// @ts-expect-error
import Visualization from './PowerPlayCri/Visualization.jsx';
import type {components} from "../../api/v1";

const PowerPlayRawCriScoreTable = ScoreTable<components['schemas']['PowerPlayCriScore']>((match) => {
...
export default function ({match}: {
  match: SeasonScore<components['schemas']['PowerPlayCriScore']>
}) {
  return <>
